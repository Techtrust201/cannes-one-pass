 ...
 *
 * Gestion interne des quotas de capacité (modèle Prisma RxCapacity, conservé
 * en interne pour cette phase). L'API est désormais générique : elle fonctionne
 * pour toutes les organisations, les zones proviennent de ZoneConfig et il n'y
 * a plus aucun hardcode LA_BOCCA/PALM_BEACH.
 *
 ...
 *
 * TODO: renommer cette route vers /api/capacities (le nom /api/rx reste legacy).
 *
...
/**
 * PATCH /api/rx/capacities?espace=<slug>
...
/**
 * DELETE /api/rx/capacities?espace=<slug>
...
export async function DELETE(req: NextRequest) {
  ...
  try {
    ...
    console.error("DELETE /api/rx/capacities error:", error);
    return Response.json({ error: "Erreur serveur" }, { status: 500 });
  }
}
