...
export interface PdfT {
  ...
  /** Bandeau d'en-tête pour un document VALIDÉ (mode official uniquement). */
  ...
  address: string;
  gpsCoords: string;
  /** Libellé du lien cliquable Google Maps (zone d'attente). */
  mapsLink: string;
  contact: string;
  email: string;
  phone: string;
  ...
  /** Libellé de statut pour une DEMANDE non validée (mode request). Ne doit
   *  jamais afficher « VALIDÉE » : une demande publique n'est pas validée. */
...
const fr: PdfT = {
  ...
  officialBanner: "DEMANDE VALIDÉE",
...
const en: PdfT = {
  ...
  officialBanner: "REQUEST APPROVED",
  ...
  requestStatusLabel: "To be validated",
  statusLabels: {
    NOUVEAU: "NEW",
    ATTENTE: "VALIDATED",
    ENTREE: "ENTRY",
...
const de: PdfT = {
  ...
  officialBanner: "ANTRAG VALIDIERT",
  ...
  requestStatusLabel: "Zu validieren",
...
const es: PdfT = {
  ...
  officialBanner: "SOLICITUD VALIDADA",
